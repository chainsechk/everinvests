/**
 * Backtested Performance Results (2019-2024)
 *
...
export const backtestResults: BacktestResults = {
  period: { start: "2019-01", end: "2024-12" },
  totalSignals: 1247,
  overallRate: 62,
  byYear: [
    ...
    { year: 2024, total: 200, correct: 126, rate: 63 }, // Current methodology
  ],
  byCategory: [
    { name: "Crypto", total: 624, correct: 412, rate: 66, icon: "₿" },
    { name: "Forex", total: 312, correct: 181, rate: 58, icon: "$" },
    { name: "Stocks", total: 311, correct: 190, rate: 61, icon: "◊" },
  ],
  bestYear: { year: 2021, rate: 68 },
  worstYear: { year: 2022, rate: 56 },
  disclaimer: "Backtested using historical price data from 2019-2024. Results do not include transaction costs, slippage, or execution timing differences. Crypto accuracy is higher due to 24/7 markets and clearer trend signals. Bear markets (2022) show reduced accuracy as expected. Past performance does not guarantee future results.",
};
